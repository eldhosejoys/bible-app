        ...
        <>
         <nav className="navbar navbar-expand-sm navbar-dark sticky-top" style={{backgroundColor:"#344955"}}>
                <div className="container justify-content-center">
                    ...
                    <form className="form-inline mb-2 input-group" target="_blank" action="/search" method="GET"><input className="form-control" type="search" placeholder="മലയാളത്തിൽ വേദവാക്യങ്ങൾ തിരയുക..." aria-label="Search" name="q" required="" />
