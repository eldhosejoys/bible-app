        ...
        <>
         <nav className="navbar navbar-expand-sm navbar-dark sticky-top" style={{backgroundColor:"#344955"}}>
                <div className="container justify-content-center mb-2">
                    ...
                    <form className="form-inline input-group" action="/search" method="GET"><input className="form-control" type="search" placeholder="മലയാളത്തിൽ വേദവാക്യങ്ങൾ തിരയുക..." aria-label="Search" name="q" required="" />
