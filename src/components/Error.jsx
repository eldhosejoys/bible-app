                            ...
                            <div className="row justify-content-center ">
                                <div className="col-lg-6 col-xxl-6 ">
                                    <div className="text-center text-light my-2 ">
                                        ...
                                        <a className="btn btn-primary text-light btn-lg " href="javascript:history.back()">Back</a> <a className="btn btn-success text-light btn-lg " href="/ ">Navigate to Home</a></div>
                                </div>
                            </div>
                        </div>
                    </header>
